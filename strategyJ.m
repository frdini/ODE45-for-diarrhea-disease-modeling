...
set.xi      = 0.8;       % rate of carrier fly lay pathogen on water or food
set.alpha   = 0.03;       % efficiency of elimination of breeding site
set.phi = 0.1;           % efficiency of sanitation
set.vartheta = 0.04;      % efficiency of installation UV light trap

set.rho = 0.01;           % efficiency of isolation of infected human
...
set.D2ih    = 0.2;       % diffusion coefficient among infected human
...
function deriv = ode_system (time, x, set)
...
dSf = set.lambda * Sf + set.psiU *Uf - set.betaSf * Sf - set.gamma * Sf + set.D1sf * Sf - set.phi * Sf - set.vartheta * Sf;
...
dIh = set.xi * set.eta * Sh - set.betaIH * Ih - set.omegaIH * Ih - set.epsilon * Ih + set.D2ih * Ih - set.rho * Ih - set.tau * Ih; 
