...
set.xi      = 0.75;       % rate of carrier fly lay pathogen on water or food
...
%sanitation
dSfS = set.lambda * SfS + set.psiU *Uf - set.betaSf * SfS - set.gamma * SfS + set.D1sf * SfS - set.vartheta * SfS;
